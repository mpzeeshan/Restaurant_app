...
class SavedAddresses extends StatefulWidget {
  ...
  @override
  _SavedAddressesState createState() => _SavedAddressesState(this.manageAddress,this.fromCart);
}
                        ...
                        onPressed: () {
                          if(manageAddress == true){
                            Navigator.push(
                             ...
                             Navigator.push(
                               context,
                               MaterialPageRoute(builder: (context) => Cart(false,selectedAddress)),
                             );
                           }


                        },
                        child: Text(manageAddress ? 'ADD NEW':
                          'CART',
