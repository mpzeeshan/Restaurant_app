...
class _LoginState extends State<Login> {
  ...
  final phone_num = RegExp(r"(\d\d\d\d\d\d\d\d\d\d)");
  String phone;
  bool _validate = true;


  Future<OtpModel> otp_model;
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                errorText: _validate ? null : 'Please enter a 10 digit phone number',
                              ),
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: RaisedButton(
                              ...
                              onPressed: () {
                                setState(() {
                              if (phone_num.hasMatch(phoneController.text)) {
                                _validate = true;
                                OtpService().get_phone(phoneController.text);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
